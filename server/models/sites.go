...
type Site struct {
	...
	SiteRepresentativeID uint        `boil:"site_representative_id" json:"site_representative_id" toml:"site_representative_id" yaml:"site_representative_id"`
...
var SiteColumns = struct {
	...
	Name:                 "name",
	Address:              "address",
	SiteRepresentativeID: "site_representative_id",
...
var SiteTableColumns = struct {
	...
	SiteRepresentativeID: "sites.site_representative_id",
...
var SiteWhere = struct {
	...
	SiteRepresentativeID whereHelperuint
	CreatedAt            whereHelpernull_Time
	UpdatedAt            whereHelpernull_Time
}{
	ID:                   whereHelperuint{field: "`sites`.`id`"},
	Name:                 whereHelpernull_String{field: "`sites`.`name`"},
	Address:              whereHelpernull_String{field: "`sites`.`address`"},
	SiteRepresentativeID: whereHelperuint{field: "`sites`.`site_representative_id`"},
	CreatedAt:            whereHelpernull_Time{field: "`sites`.`created_at`"},
	UpdatedAt:            whereHelpernull_Time{field: "`sites`.`updated_at`"},
}
...
var (
	siteAllColumns            = []string{"id", "name", "address", "site_representative_id", "created_at", "updated_at"}
	siteColumnsWithoutDefault = []string{"name", "address", "site_representative_id", "created_at", "updated_at"}
...
func SiteExists(ctx context.Context, exec boil.ContextExecutor, iD uint) (bool, error) {
	var exists bool
