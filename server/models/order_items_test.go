...
var (
	orderItemDBTypes = map[string]string{`ID`: `int`, `OrderDate`: `date`, `Note`: `text`, `SubTotal`: `int`, `Quotation`: `varchar`, `Invoice`: `varchar`, `TotalPrice`: `int`, `Remarks`: `text`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `OrderID`: `int`, `Claim`: `varchar`, `OrderFile`: `varchar`}
	_                = bytes.MinRead
)
