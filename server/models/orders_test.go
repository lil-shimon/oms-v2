...
var (
	orderDBTypes = map[string]string{`ID`: `int`, `StartDate`: `varchar`, `EndDate`: `varchar`, `ExpectedStartDate`: `varchar`, `ExpectedEndDate`: `varchar`, `InvoiceNote`: `text`, `SaleNote`: `text`, `MaintainanceNote`: `text`, `SimNumber`: `int`, `SignnageID`: `int`, `ConditionID`: `int`, `UserID`: `int`, `DeletedAt`: `timestamp`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `CompanyName`: `varchar`, `SiteName`: `varchar`, `AdditionalInvoiceID`: `int`, `ConditionName`: `varchar`, `AdditionalInvoice`: `varchar`, `Payment`: `varchar`, `Comment`: `text`, `PhoneNumber`: `varchar`, `SiteRepresentative`: `varchar`, `SiteRepresentativePhone`: `varchar`, `SiteMail`: `varchar`, `SiteAddress`: `varchar`, `TotalPrice`: `int`, `SiteOfficeAddress`: `varchar`, `DocumentID`: `int`}
	_            = bytes.MinRead
)
