...
var (
	userDBTypes = map[string]string{`ID`: `int`, `Name`: `varchar`, `Email`: `varchar`, `Password`: `varchar`, `CompanyID`: `int`, `ParentID`: `int`, `RememberToken`: `varchar`, `CreatedAt`: `timestamp`, `UpdatedAt`: `timestamp`, `DeletedAt`: `timestamp`}
	_           = bytes.MinRead
)
