...
type User struct {
	...
	CompanyID     uint        `boil:"company_id" json:"company_id" toml:"company_id" yaml:"company_id"`
	ParentID      null.Uint   `boil:"parent_id" json:"parent_id,omitempty" toml:"parent_id" yaml:"parent_id,omitempty"`
...
var UserWhere = struct {
	...
	CompanyID:     whereHelperuint{field: "`users`.`company_id`"},
	ParentID:      whereHelpernull_Uint{field: "`users`.`parent_id`"},
...
var (
	userAllColumns            = []string{"id", "name", "email", "password", "company_id", "parent_id", "remember_token", "created_at", "updated_at", "deleted_at"}
	userColumnsWithoutDefault = []string{"name", "email", "password", "company_id", "parent_id", "remember_token", "created_at", "updated_at", "deleted_at"}
